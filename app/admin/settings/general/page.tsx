            ...
            <div className="space-y-8">
                ...
                <section className="bg-white p-8 rounded-2xl border border-neutral-200 shadow-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Logo URL (Preview)</label>
                            <div className="flex gap-4 items-start">
                                <div className="flex-1 space-y-2">
                                    ...
                                    />
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">Direct link to your logo image. File upload coming soon.</p>
                                </div>
                ...
                <section className="bg-white p-8 rounded-2xl border border-neutral-200 shadow-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            {...register("about")}
                            className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl font-medium focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all min-h-[160px] shadow-sm"
