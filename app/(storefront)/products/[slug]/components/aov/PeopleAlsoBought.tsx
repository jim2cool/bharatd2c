...
export function PeopleAlsoBought({ products, title }: PeopleAlsoBoughtProps) {
                ...
                >
                    <CarouselContent className="-ml-4">
                        {products.map((product) => (
                            <CarouselItem key={product.id} className="pl-4 basis-[60%] md:basis-1/3 lg:basis-1/4">
                                <Link href={`./${product.slug}`} className="group block h-full">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <h3 className="font-normal text-sm text-foreground group-hover:underline underline-offset-4 decoration-1 decoration-foreground/50 transition-all truncate pr-4">
                                            {product.title}
                                        </h3>
