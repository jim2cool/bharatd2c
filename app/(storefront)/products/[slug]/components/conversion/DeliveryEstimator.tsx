...
export function DeliveryEstimator() {
    ...
    return (
        <div className="bg-muted rounded-xl p-4 border border-border mt-2">
            <div className="flex items-center gap-2 mb-3">
                <MapPin className="w-3.5 h-3.5 text-muted-foreground" />
                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Delivery Check</span>
            </div>
            ...
            <div className="flex gap-2">
                <div className="relative flex-1">
                    <input
                        ...
                        className="w-full bg-card border border-border rounded-lg px-3 py-2 text-sm font-bold focus:ring-1 focus:ring-black outline-none transition-all"
                    />
                    {status === 'success' && (
                ...
                <button
                    ...
                    className="px-4 py-2 bg-neutral-900 text-primary-foreground rounded-lg text-xs font-black uppercase tracking-tighter hover:bg-foreground transition-all disabled:opacity-30"
                >
